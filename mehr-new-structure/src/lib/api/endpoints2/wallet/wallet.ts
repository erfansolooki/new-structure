...
/**
 * @summary required permisson: read_wallet
 */
...
/**
 * @summary required permisson: update_wallet
 */
 ...
 * @summary required permisson: update_wallet
 */
export const walletControllerCorrectBalance = (
  correctBalanceDto: CorrectBalanceDto,
  signal?: AbortSignal
) => {
  return apiInstance<Wallet>({
    url: `/api/wallet/correct-balance`,
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    data: correctBalanceDto,
    signal,
  });
};

export const getWalletControllerCorrectBalanceMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof walletControllerCorrectBalance>>,
    TError,
    { data: CorrectBalanceDto },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ['walletControllerCorrectBalance'];
  const { mutation: mutationOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
  ...
  > = (props) => {
    ...
    return walletControllerCorrectBalance(data);
  };

  return { mutationFn, ...mutationOptions };
};

export type WalletControllerCorrectBalanceMutationResult = NonNullable<
  Awaited<ReturnType<typeof walletControllerCorrectBalance>>
>;
export type WalletControllerCorrectBalanceMutationBody = CorrectBalanceDto;
export type WalletControllerCorrectBalanceMutationError = unknown;

/**
 * @summary required permisson: update_wallet
 */
export const useWalletControllerCorrectBalance = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof walletControllerCorrectBalance>>,
      TError,
  ...
  TContext
> => {
  const mutationOptions = getWalletControllerCorrectBalanceMutationOptions(options);
